        ...
        <div className="mx-auto max-w-6xl space-y-5">
          <header className="rounded-2xl border border-[#a8874e]/25 bg-[#2d211b] p-5 sm:p-6">
            ...
            <div className="mt-5 rounded-xl border border-[#a8874e]/20 bg-[#fff7e6]/5 p-4 text-sm leading-6 text-[#f3ead8]/75">
              <strong>Viewing is not acceptance.</strong> Viewing this page does not create acceptance or make the contract effective. <strong>Viewing this page does not</strong> accept, sign, amend, or make the contract effective. Wewed records acceptance only after an explicit party decision against the exact fingerprints below. Payment or message delivery cannot make the contract effective.
            </div>
