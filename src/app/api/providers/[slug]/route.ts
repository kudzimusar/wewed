      ...
      provider: {
        ...
        offerings: offerings.map((offering) => ({
          ...
          packages: packages.filter((entry) => entry.offeringId === offering.id).map((entry) => ({
            ...
            minimumQuantity: typeof entry.minimumQuantity === 'number' ? entry.minimumQuantity : null,
            maximumQuantity: typeof entry.maximumQuantity === 'number' ? entry.maximumQuantity : null,
            includedQuantity: typeof entry.includedQuantity === 'number' ? entry.includedQuantity : null,
            additionalUnitPriceCents: typeof entry.additionalUnitPriceCents === 'number' ? entry.additionalUnitPriceCents : null,
            priceValidUntil: entry.priceValidUntil ?? null,
            completionScore: typeof entry.completionScore === 'number' ? entry.completionScore : 0,
          })),
