...
export function AdminUtilityNav() {
  ...
  return (
    <nav
      className="fixed bottom-4 left-1/2 z-50 flex max-w-[96vw] -translate-x-1/2 items-center gap-1 overflow-x-auto rounded-full border border-gold/25 bg-espresso/95 p-1.5 shadow-2xl backdrop-blur"
