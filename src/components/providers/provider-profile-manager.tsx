...
function PriceComponentEditor({ category, value, onChange }: { category: string; value: PriceComponentDraft[]; onChange: (value: PriceComponentDraft[]) => void }) {
...
function PackageEditor({ category, value, currency, offeringCommercialTerms, onChange }: { category: string; value: PackageDraft[]; currency: string; offeringCommercialTerms: CommercialTermsDraft; onChange: (value: PackageDraft[]) => void }) {
  const bindingOptions = providerPriceBindingOptions(category)
