...
describe('targeted home, marketplace and provider iteration', () => {
  ...
  test('provider registration preserves review flow with multi-service preselection', () => {
    ...
    expect(form).toContain('requestedServices: reservedFlow ? [] : isProvider ? requestedServices : []')
    expect(form).toContain('requestedService: reservedFlow ? null : isProvider ? requestedServices[0] : null')
    expect(form).toContain('reservedProfileSlug: reservedFlow ? reservedProfileSlug : null')
