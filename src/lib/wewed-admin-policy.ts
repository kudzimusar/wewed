...
export function isPlatformAccountType(value: unknown): value is PlatformAccountType {
  return typeof value === 'string' && (PLATFORM_ACCOUNT_TYPES as readonly string[]).includes(value)
}
