...
describe('premium digital invitation experience', () => {
  ...
  test('the interactive invitation surface connects guest actions instead of becoming a decorative dead end', () => {
    ...
    expect(experience).toContain('testId="invitation-cta-rsvp"')
    expect(experience).toContain('testId="invitation-cta-calendar"')
    expect(experience).toContain('testId="invitation-cta-venue"')
    expect(experience).toContain('testId="invitation-cta-registry"')
    expect(experience).toContain('testId="invitation-cta-note"')
