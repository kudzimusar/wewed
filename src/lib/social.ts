...
export const WEDED_SHARE_URL = 'https://wewed.app/charity-and-kudzie';
...
export const SOCIAL_HANDLES = {
  instagram: 'https://instagram.com/wewed.app',
  facebook: 'https://facebook.com/wewed.app',
  twitter: 'https://twitter.com/wewed_app',
  tiktok: 'https://tiktok.com/@wewed.app',
} as const;
