...
beforeEach(() => { query = undefined; rawQueries = 0 })
// The first three tests are inherited unchanged from the Guest Session v2 promotion branch this
// one is stacked on — see that branch's own commit removing this file's ./wedding-day coupling.
// The last two are this branch's own addition: they exercise guestPassForRequest and
// readWeddingDayGuestContext, which only exist here.
