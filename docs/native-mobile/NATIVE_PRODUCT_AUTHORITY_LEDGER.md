...
| **PLAN-09** | Digital & Physical Invitations / RSVP | `/invite/[slug]/open`, `/couple/invitations` | Couple, Guest, Planner | `NATIVE-TESTED` | `NATIVE-TESTED` | `NATIVE-TESTED` | Ivory card presentation, physical pass barcode sync, RSVP confirmation. |
