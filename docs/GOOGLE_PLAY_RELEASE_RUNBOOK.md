...
- Latest release: **Closed testing - Alpha release 9**, version name `2.1.0`, version code `9`; available to selected testers in all 35 targeted regions
- Target SDK: 36
- Status on 25 September 2026: **closed-test release 9 is active**. Google Play reports it was released on 24 September 2026 at 4:57 PM and is available to selected testers in all 35 targeted regions, including Zimbabwe.
- Tester access: the existing **Beta Testers** email list is assigned to the track and contains 31 accounts.
- Production-access progress on 25 September 2026: **4 testers are currently opted in**. Google requires at least 12 opted-in testers to remain in the closed test for at least 14 continuous days before this personal developer account can apply for production access.
