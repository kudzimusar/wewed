...
SELECT
  ...
  o."displayName",
  COALESCE(NULLIF(o.description,''),'Browse Shandy wedding gowns and bridal accessories, then request the exact gown, fitting and hire details you need.'),
  'hybrid',
  'quote',
  'published',
  NULL,
...
SELECT
  ...
  o."displayName",
  COALESCE(NULLIF(o.description,''),'Request chairs and event rental essentials for your wedding. Exact quantity, stock and delivery details are confirmed by Shandy before booking.'),
  'quantity_rental',
  'quote',
  'published',
  NULL,
...
SELECT
  ...
  o."displayName",
  COALESCE(NULLIF(o.description,''),'Request wedding tent and marquee hire. Size, capacity, setup, delivery, date availability and price are confirmed by Shandy before booking.'),
  'quantity_rental',
  'quote',
  'published',
  NULL,
