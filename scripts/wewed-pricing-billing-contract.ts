...
assert(billingPortal.includes('Cancels at period end'), 'Billing must surface scheduled cancellation state.')
...
assert(billingSyncRoute.includes('cancel_at_period_end'), 'Reconciliation must retrieve Stripe scheduled cancellation state.')
...
assert(webhookRoute.includes('object.cancel_at_period_end'), 'Webhooks must persist Stripe scheduled cancellation changes.')
