...
SCRIPTS = [
    ...
    'scripts/contributions-generated-test-normalization.py',
]
...
print('All Contributions second-review remediation slices and generated contract normalization applied.')
