...
DO $$
DECLARE acceptance_def text; effectivity_def text; lifecycle_def text;
BEGIN
...
BEGIN
  ...
  LEFT JOIN wewed_contracts."ContractPartyRequirement" r ON r."id"=a."requirementId"
  WHERE r."id" IS NULL;
  IF orphaned <> 0 THEN RAISE EXCEPTION 'Acceptance without requirement detected'; END IF;
END $$;
